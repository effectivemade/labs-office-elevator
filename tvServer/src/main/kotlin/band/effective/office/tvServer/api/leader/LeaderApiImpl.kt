...
class LeaderApiImpl(private val client: HttpClient) : LeaderApi {
    override suspend fun searchEvents(
        ...
        cityId: Int,
        placeId: Int
    ): SearchEventsResponse = client.get("https://leader-id.ru/api/v4/events/search") {
    ...
    }.body() //"api/v4/events/search"

    override suspend fun eventInfo(eventId: Int): EventInfoResponse =
        client.get("https://leader-id.ru/api/v4/events/${eventId}").body() //api/v4/events/{eventId}
}