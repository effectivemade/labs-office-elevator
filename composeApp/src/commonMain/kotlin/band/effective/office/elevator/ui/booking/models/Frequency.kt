...
class Frequency(private val days: List<Pair<String, Int>>, private val researchEnd: Triple<String, String, String>) {
    ...
    fun getResearchEnd(): Triple<String, String, String>{
