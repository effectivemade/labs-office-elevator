...
class AboutEmployeeInteractor(
    ...
    suspend fun getBookingsForUser(
        ...
        bookingRepository.getBookingsForUser(ownerId = ownerId, bookingsFilter = bookingsFilter)
    ...
    suspend fun getBookingsByDate(
        ...
        bookingRepository.getBookingsByDate(date = date, ownerId = ownerId, bookingsFilter = bookingsFilter)
            .map { bookingsList -> bookingsList.toUIModel() }
            .stateIn(coroutineScope)
}